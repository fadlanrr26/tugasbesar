    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 class="text-black">Programmer</h2>
            <p> adalah seorang profesional yang menulis kode komputer. Mereka menggunakan bahasa pemrograman untuk membuat program komputer yang digunakan untuk berbagai tujuan, termasuk aplikasi web dan seluler, game, dan perangkat lunak bisnis..</p>
