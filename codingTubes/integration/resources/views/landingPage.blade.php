            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">JasaHub</h1>
	                        <p class="hero-paragraph">
                                Dengan JasaHub, platform freelance revolusioner kami, temukan keleluasaan dan kenyamanan dalam menjalankan proyek-proyek freelance Anda. Hubungkan diri Anda dengan ribuan profesional berbakat dan pemberi proyek yang mencari keahlian Anda. Nikmati pengalaman berfreelance yang lebih efisien dan transparan dengan fitur-fitur inovatif kami. Bergabunglah dengan JasaHub hari ini dan temukan dunia baru di mana bakat dan peluang berkumpul dalam satu tempat!
                            </p>
	                        <div class="hero-cta">
								<a class="button button-primary" href="{{route('login')}}">Login Sekarang</a>
					...
					<div class="features-inner section-inner has-bottom-divider">
						<div class="features-header text-center">
							<div class="container-sm">
								<h2 class="section-title mt-0">JasaHub</h2>
	                            <p class="section-paragraph">
                                    JasaHub, seperti peluk hangat mentari di tengah ladang kreativitas, tempat di mana ide-ide bersinar seperti bintang-bintang malam. Sebuah aliran inspirasi yang mengalir bebas, menghubungkan bakat-bakat gemilang dengan peluang emas, seakan-akan menjadi simfoni keberhasilan di antara jutaan galaksi aspirasi.
                                </p>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	<h3 class="feature-title mt-0">Economy</h3>
                                    	<p class="text-sm mb-0">Sustainable economic growth serves as the key to fostering societal well-being and elevating the global standard of living.</p>
									</div>
								</div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	<h3 class="feature-title mt-0">Growth</h3>
                                    	<p class="text-sm mb-0">Sustainable growth serves as the foundation for progress and evolution, bringing positive benefits to both individuals and society.</p>
									</div>
								</div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	<h3 class="feature-title mt-0">Empowerment</h3>
                                    	<p class="text-sm mb-0">Growth is a natural process that brings about change and opportunities, creating a foundation for development and sustainability.</p>
									</div>
								</div>
                            </div>
                        </div>
                ...
                <div class="container-sm">
                    <div class="cta-inner section-inner">
                        <div class="cta-header text-center">
                            <h2 class="section-title mt-0">Start Now</h2>
                            <p class="section-paragraph">Economic growth doesn't mean anything if it leaves people out</p>
							<div class="cta-cta">
								<a class="button button-primary" href="{{route('formRegister')}}">Registration</a>
							</div>
					    </div>
                    </div>
                </div>
        ...
        <footer class="site-footer has-top-divider">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2023 Switch, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
