...
<html lang="en">
  <head>
    <title>jasahub &mdash; Colorlib e-Commerce Template</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="index.html" class="js-logo-clone">jasaHUB</a>
              </div>
            </div>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Illustrator</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="templateHome/images/shoe_1.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <h2 class="text-black">video editor</h2>
            <p>professional yang Menambahkan efek visual dan audio untuk meningkatkan produksi video menyesuaikan warna dan pencahayaan video dan menambahkan teks dan grafik ke video </p>
  ...
  <script src="templateHome/jquery.magnific-popup.min.js"></script>
