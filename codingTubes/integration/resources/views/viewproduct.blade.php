...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{ route('home')}}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Illustrator</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <h2 class="text-black">Illustrator</h2>
            <p>menciptakan karya seni dengan menggunakan perangkat elektronik, seperti komputer, tablet, atau ponsel pintar. Mereka menggunakan perangkat lunak desain grafis untuk menggambar, mewarnai, dan menambahkan efek </p>
