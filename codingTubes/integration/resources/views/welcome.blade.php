...
<html lang="en">
  <head>
    <title>jasaHUB &mdash; jasaHUB</title>
    <meta charset="utf-8">
              ...
              <div class="site-top-icons">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon-heart-o"></span></a></li>
                    ...
                    <a href="{{ route('view')}}" class="site-cart">
      ...
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
            <h1 class="mb-2">carilah jasa layanan digital terbaik!</h1>
            <div class="intro-text text-center text-md-left">
              <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus at iaculis quam. Integer accumsan tincidunt fringilla. </p>
              <p>
                <a href="{{route('shop')}}" class="btn btn-sm btn-primary">Cari sekarang!</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4 d-lg-flex mb-4 mb-lg-0 pl-4" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="text">
              <h2 class="text-uppercase">Fre</h2>
